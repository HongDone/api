<section>
    ...
    if (isset($_POST["submit"]) && $_POST["submit"] == "Update") {
        ...
        $uncheckedImages = array_diff($allImages, $checkedImages);
    ...
    ?>
    <form action="" method="POST" id="productDetails">
        <table border='0'>
            <tr>
                <td colspan=4>
                    Product name: <br>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input name="sale_price" min=0 pattern="[^\-]+" style="color: red;" type="number"
                        value="<?php echo $data["sale_price"]; ?>">
                </td>
                <td>
                    Stock Quantity: <br>
                    <input name="stock_quantity" min=0 pattern="[^\-]+" type="number"
                        value="<?php echo $data["stock_quantity"]; ?>">
                </td>
                <td>
                    Tags: <br>
            ...
            <tr>
                ...
                <td>Post Status: <br>
                    <input type="radio" id="publish" name="status" value="publish"> <label
                        style="margin-right: 30px;">Publish</label>
                    <input type="radio" id="pending" name="status" value="pending"> <label>Pending</label> <br>
                    <input type="radio" id="private" name="status" value="private"> <label
                        style="margin-right: 32px;">Private
                    </label>
                ...
                <td colspan=3>
                    ...
                    <div class="editor-box">
                        <textarea name="editor"
                            id="editor"><?php echo html_entity_decode($data["description"]); ?></textarea>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <ul class="product_action_btn">
                        <li>
                            <a href="http://localhost/fluffybunny/api/products?id=<?php echo $data['id'] ?>&action=delete"
                                id="deleteProduct">Delete</a>
                        </li>
